...
<cfif StructKeyExists(form, 'frequency_id')>
  <cfif form.old_frequency_id3 NEQ form.cycle_id>

    <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_frequency_id3, form.frequency_id, 'frequency')> 

            </cfif>
</cfif>

<cfif StructKeyExists(form, 'cycle_id')>
  <cfif form.old_cycle_id3 NEQ form.cycle_id>

         <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_cycle_id3, form.cycle_id, 'cycle')> 

            </cfif>
</cfif>


         <cfif StructKeyExists(form, 'state_id') AND form.old_state_id3 NEQ form.state_id >

            

      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_state_id3, form.state_id, 'state')> 


            </cfif>

    <cfif StructKeyExists(form, 'branch')> 
    <cfif form.old_branch3 NEQ form.branch>

      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_branch3, form.branch,     'branch')> 
    ...
    <cfif StructKeyExists(form, 'address')>
           <cfif form.old_street_address3 NEQ form.address>

              <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_street_address3, form.address, 'address')> 
    ...
    <cfif StructKeyExists(form, 'city')>
          <cfif form.old_city3 NEQ form.city>
 ...
 --->
                 <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_city3, form.city, 'city')> 
    ...
    <cfif StructKeyExists(form, 'zip')>
         <cfif form.old_zip3 NEQ form.zip>


              
          <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_zip3, form.zip, 'zip')> 
        ...
        <cfif  StructKeyExists(form ,'county') AND form.old_county3 NEQ form.county >


    
                 <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_county3, form.county, 'county')> 


        </cfif>

       
           <cfif StructKeyExists(form,'parcel') AND form.old_parcel3 NEQ form.parcel >


            <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_parcel3, form.parcel, 'parcel')> 


            </cfif>

         
        <cfif StructKeyExists(form,'block') AND form.old_block3 NEQ form.block >
         
      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_block3, form.block, 'block')>
         ...
         <cfif StructKeyExists(form,'lot') AND form.old_lot3 NEQ form.lot >

         
             <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_lot3, form.lot, 'lot')> 

        </cfif>

        <cfif StructKeyExists(form,'notes') AND form.old_notes3 NEQ form.notes >

           
             <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_notes3, form.notes, 'notes')> 
...
<cfset cmp = compare('form.old_frequency_id2', 'form.frequency_id')>

<cfif StructKeyExists(form ,'frequency_id')>
          <cfif cmp neq 0>

    <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_frequency_id2, form.frequency_id, 'frequency')> 

            </cfif>
</cfif>

<cfif StructKeyExists(form, 'cycle_id')>
  <cfif form.old_cycle_id2 NEQ form.cycle_id>

         <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_cycle_id2, form.cycle_id, 'cycle')> 

            </cfif>
</cfif>


         <cfif StructKeyExists(form, 'state_id') AND form.old_state_id2 NEQ form.state_id >

            

      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_state_id2, form.state_id, 'state')> 


            </cfif>

    <cfif StructKeyExists(form, 'branch')> 
    <cfif form.old_branch2 NEQ form.branch>

      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_branch2, form.branch,     'branch')> 
    ...
    <cfif StructKeyExists(form, 'address')>
           <cfif form.old_street_address2 NEQ form.address>

              <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_street_address2, form.address, 'address')> 
    ...
    <cfif StructKeyExists(form, 'city')>
          <cfif form.old_city2 NEQ form.city>
 ...
 --->
                 <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_city2, form.city, 'city')> 
    ...
    <cfif StructKeyExists(form, 'zip')>
         <cfif form.old_zip2 NEQ form.zip>


              
          <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_zip2, form.zip, 'zip')> 
        ...
        <cfif  StructKeyExists(form ,'county') AND form.old_county2 NEQ form.county >


    
                 <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_county2, form.county, 'county')> 


        </cfif>

       
           <cfif StructKeyExists(form,'parcel') AND form.old_parcel2 NEQ form.parcel >


            <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_parcel2, form.parcel, 'parcel')> 


            </cfif>

         
        <cfif StructKeyExists(form,'block') AND form.old_block2 NEQ form.block >
         
      <cfset
        sendToDiffQry(url.tax_search_loan_id, form.old_block2, form.block, 'block')>
         ...
         <cfif StructKeyExists(form,'lot') AND form.old_lot2 NEQ form.lot >

         
             <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_lot2, form.lot, 'lot')> 

        </cfif>

        <cfif StructKeyExists(form,'notes') AND form.old_notes2 NEQ form.notes >

           
             <cfset
                 sendToDiffQry(url.tax_search_loan_id, form.old_notes2, form.notes, 'notes')> 

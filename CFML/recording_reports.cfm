        ...
        <td>
            ...
            <table>
                <tr>
                  ...
                  <td style="font-size: 18px; color: #FFFFFF;">Period</td>
                </tr>
                <tr>
                    <td>
...
<cfif IsDefined('url.status_selection')>
    ...
    <CFSET COMParams = "w3HostName=SEARCHTEC&w3Exec=OMSW3&sessionid=#client.sessionid#&FUNCTION=RECORDING_REPORT_LARRY&family=&page_offset=#url.page_offset#&num_rows=#num_rows#&custcode=#cust_codes#&order_status=#url.status_selection#&sort_by=#url.sort_selection#&status_period=#url.status_period#">

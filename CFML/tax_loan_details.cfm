...
<cfif isDefined('form.old_frequency_id')>
<cfoutput>Defined</cfoutput>
</cfif>
...
<cfset cmp = compare(form.old_frequency_id, form.frequency)>
<cfif  isDefined("form.frequency_id")>
          <cfif cmp neq 0>
          ...
          <!---    <cfif form.old_cycle_id NEQ form.cycle_id AND isDefined("form.cycle_id")>

                <cfset count = count + 1>

            </cfif>
         <cfif form.old_state_id NEQ form.state_id AND isDefined("form.state_id")>

        
                <cfset count = count + 1>

            </cfif>
           <cfif form.old_branch NEQ form.branch AND isDefined("form.branch_id")>

                <cfset count = count + 1>

            </cfif>
           <cfif form.old_street_address NEQ form.street_address AND isDefined("form.street_address")>

                <cfset count = count + 1>

            </cfif>
          <cfif form.old_city NEQ form.city AND isDefined("form.city")>

                <cfset count = count + 1>

            </cfif>
         <cfif form.old_zip NEQ form.zip AND isDefined("form.zip")>
        ...
        <cfif form.old_country NEQ form.country AND isDefined("form.country")>
           ...
           <cfif form.old_parcel NEQ form.parcel AND isDefined("form.parcel")>

        
                <cfset count = count + 1>

                    </cfif>
        <cfif form.old_block NEQ form.block AND isDefined("form.block")>
         
                <cfset count = count + 1>

                    </cfif>
         <cfif form.old_lot NEQ form.lot AND isDefined("form.lot")>

         
                <cfset count = count + 1>
                </cfif>

         <cfif form.old_notes NEQ form.notes AND isDefined("form.notes")>
...
<cfif count gt 0>
<cfset oldArray = ArrayNew(count)>
<cfset newArray = ArrayNew(count)>
<cfset nameArray = ArrayNew(count)>

           <cfif form.old_frequency_id NEQ form.frequency_id AND isDefined("form.frequency_id")>
<!--- 
                <cfoutput>#ArrayAppend(oldArray, "#form.old_frequency_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.frequency_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "frequency")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
                </cfif>
     ...
     <cfif form.old_cycle_id NEQ form.cycle_id AND isDefined("form.cycle_id")>
                    ...
                    <!---   <cfoutput>#ArrayAppend(oldArray, "#form.old_cycle_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.cycle_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "cycle")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>

            <cfif form.old_state_id NEQ form.state_id AND isDefined("form.state_id")>

  <!---                <cfoutput>#ArrayAppend(oldArray, "#form.old_state_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.state_id#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "state")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>

            <cfif form.old_branch NEQ form.branch AND isDefined("form.branch")>

           <!---      <cfoutput>#ArrayAppend(oldArray, "#form.old_branch#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.branch#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "branch")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>

         <cfif form.old_street_address NEQ form.street_address AND isDefined("form.street_address")>

        <!---         <cfoutput>#ArrayAppend(oldArray, "#form.old_street_address#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.street_address#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "street address")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
             <cfif form.old_city NEQ form.city AND isDefined("form.city")>

               <!---  <cfoutput>#ArrayAppend(oldArray, "#form.old_city#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.city#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "old city")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
           <cfif form.old_zip NEQ form.zip AND isDefined("form.zip")>

       <!---          <cfoutput>#ArrayAppend(oldArray, "#form.old_zip#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.from#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "from")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
          <cfif form.old_country NEQ form.country AND isDefined("form.country")>

              <!---   <cfoutput>#ArrayAppend(oldArray, "#form.old_country#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.country#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "old country")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
              <cfif form.old_parcel NEQ form.parcel AND isDefined("form.parcel")>
<!--- 
                 <cfoutput>#ArrayAppend(oldArray, "#form.old_parcel#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.parcel#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "parcel")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
           <cfif form.old_block NEQ form.block AND isDefined("form.block")>
        <!---         <cfoutput>#ArrayAppend(oldArray, "#form.old_block#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.block#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "block")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>
           <cfif form.old_lot NEQ form.lot AND isDefined("form.lot")>

          <!---        <cfoutput>#ArrayAppend(oldArray, "#form.old_lot#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.lot#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "form")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
            </cfif>

            <cfif form.old_notes NEQ form.notes AND isDefined("form.notes")>

              <!---    <cfoutput>#ArrayAppend(oldArray, "#form.old_notes#")#</cfoutput>
                <cfoutput>#ArrayAppend(newArray, "#form.notes#")#</cfoutput>
                <cfoutput>#ArrayAppend(nameArray, "notes")#</cfoutput> --->
                <!--- <cfset count = count + 1> --->
